...
export default function PostJob({
  ...
  const inputStyle = (focus = false) => ({
    ...
    padding: "12px 14px",
    borderRadius: "9px",
    border: `1.5px solid ${focus ? C.blueAcc : C.border}`,
  ...
  //   if (isEdit) {
  //     setJobs((js) =>
  //       js.map((j) => (j.id === editJob.id ? { ...j, ...form } : j)),
  //     );
  //   } else {
  //     setJobs((js) => [
  //       ...js,
  //       { ...form, id: Date.now(), posted: "May 26, 2025", apps: 0, views: 0 },
  //     ]);
  //   }
  //   setSuccess(true);
  //   setTimeout(() => {
  ...
  return (
    <div style={{ maxWidth: "720px" }}>
      <SectionHeader
        title={isEdit ? `Edit: ${editJob.title}` : "Post a New Job"}
        sub={
          isEdit
              ...
              {STATUSES.map((s) => (
                <button
                  ...
                  style={{
                    ...
                    padding: "10px",
                    borderRadius: "9px",
                    border: `1.5px solid ${form.status === s ? C.blueAcc : C.border}`,
                    background: form.status === s ? C.bluePale : "transparent",
                    color: form.status === s ? C.blue : C.gray,
                    fontSize: "13px",
